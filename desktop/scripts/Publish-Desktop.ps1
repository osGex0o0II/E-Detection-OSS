...
@(
    ...
    "CodeSigning=The v2.0.2 release assets are intentionally unsigned."
    "ChecksumTrust=SHA-256 verifies file integrity, not publisher identity."
...
@(
    ...
    "The v2.0.2 installer and portable app are intentionally unsigned. Windows may show an Unknown Publisher or SmartScreen warning."
    "SHA-256 verifies file integrity, not publisher identity."
    "Verify that the download came from the official GitHub Release before comparing its checksum."
    "Checksum command:"
